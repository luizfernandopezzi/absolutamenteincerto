...
const SobrePage = () => {
  return (
    <Layout>
      <Helmet>
        <title>Sobre | Absolutamente Incerto</title>
        <meta name="description" content="Conheça Luiz Fernando Pezzi, criador do Absolutamente Incerto, um espaço de reflexão que conecta filosofia, ciência e comportamento." />
        <meta property="og:title" content="Sobre | Absolutamente Incerto" />
        <meta property="og:description" content="Conheça Luiz Fernando Pezzi, criador do Absolutamente Incerto, um espaço de reflexão que conecta filosofia, ciência e comportamento." />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            <div className="md:col-span-1 flex justify-center">
              <img 
                src="/images/criador.jpg" 
                alt="Foto de Luiz Fernando Pezzi" 
                width={250} 
                height={250} 
                className="rounded-full shadow-2xl border-4 border-purple-500 object-cover" 
                loading="lazy"
              />
            </div>
            <div className="md:col-span-2 text-gray-300 text-lg">
              <p className="mb-6">
                Olá! Sou o Luiz Fernando Pezzi, e minha história é uma busca constante por entendimento, uma ponte entre mundos aparentemente distintos.
              </p>
              <p className="mb-6">
